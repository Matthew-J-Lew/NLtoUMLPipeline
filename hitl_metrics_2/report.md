...
| S10_DelayEdit | agentic_nl_edit | delay_change | success | True | True | True | True | Agent summary: Changed the timeout for turning off the hallway light from 5 minutes to 10 minutes. / Diff summary: / - transitions added (1) / - transitions rem |
...
| S13_GuardEdit | agentic_nl_edit | guard_change | success | True | True | True | True | Agent summary: Changed the guard condition to turn on the hallway light only when User Presence is present instead of not present. / Diff summary: / - transitio |
...
| S20_NotificationEdit | manual_puml | notification_message_change | baseline_validation | False | True | True | False | Changed notification message. / Round-trip failed with 1 error(s). Fix the .puml and rerun. /   puml:L33: E420 Could not parse guard expression: ((location.mode |
| S20_NotificationEdit | agentic_nl_edit | notification_message_change | success | True | True | True | True | Agent summary: Corrected the guard condition by removing invalid 'hour' attribute and kept the updated notification message and other conditions unchanged. / Di |
...
| S12_DurationEdit | agentic_nl_edit | duration_change | agent_edit | False | False | False | False | Agent edit FAILED (patch could not be applied). / Revision: hitl_metrics_fixed_2\runs\HITL_Agent_S12_DurationEdit\edits\edit_001 / Reason: transition index out  |
