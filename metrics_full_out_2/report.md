...
Output directory: `metrics_final_out_2`
...
| Pre structural validity rate | 0.9 |
| Pre overall validity rate | 0.9 |
| Post structural validity rate | 1.0 |
| Post overall validity rate | 1.0 |
| Repair effectiveness rate | 1.0 |
| Pre downstream readiness rate | 0.9 |
...
| Artifact | Path |
| --- | --- |
| Per-scenario CSV | metrics_final_out_2\scenario_results.csv |
| Paraphrase CSV | metrics_final_out_2\paraphrase_results.csv |
| Adversarial CSV | metrics_final_out_2\adversarial_results.csv |
| Summary CSV | metrics_final_out_2\summary.csv |
| Summary JSON | metrics_final_out_2\summary.json |
