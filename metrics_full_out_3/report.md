...
Output directory: `metrics_final_out_3`
...
| Mean post similarity score | 0.7625 |
...
| Artifact | Path |
| --- | --- |
| Per-scenario CSV | metrics_final_out_3\scenario_results.csv |
| Paraphrase CSV | metrics_final_out_3\paraphrase_results.csv |
| Adversarial CSV | metrics_final_out_3\adversarial_results.csv |
| Summary CSV | metrics_final_out_3\summary.csv |
| Summary JSON | metrics_final_out_3\summary.json |
